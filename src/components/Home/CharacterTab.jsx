      ...
      >
        ...
        ${
          theme.ThemeZhongli
            ...
            : theme.ThemeFocalors
            ? "top-5 left-12 text-white font-semibold"
            : ""
        }
        ...
        <pre
          className={`${
            ...
            ${
              theme.ThemeFocalors
                ? "bottom-40 right-[45%] text-white font-semibold"
                : ""
            } absolute  opacity-0 transition ease-all duration-300 group-hover:opacity-100`}
        >
          DE
        ...
        >
          ...
          <ul className=" list-disc px-6 text-dimWhite xs:text-[14px] text-inherit sx:text-[15px] ss:text-[16px] opacity-100 transition ease-all duration-500 group-hover:opacity-0">
            ...
            <li>
              Exchanged with Masterless Starglitter Masterless Starglitter ×5
              each in the Paimon's Bargains shop.
            </li>
            <li>
